...
#COSC 1315
#August 17, 2023
#Description: This is a bursting balloon game, I added the color black and modified the code to make color changes.
...
pygame.display.set_caption("Karem - Balloon Shooter Game")
clock = pygame.time.Clock()  #Added my name to display caption
...
purple = (155, 89, 182)
orange = (243, 156, 18)
black = (0, 0, 0, 255)   #Added black color

font = pygame.font.SysFont("Calibri", 25)  #Changed the font
...
class Balloon:
    def __init__(self, speed):
        ...
        self.color = random.choice([red, white])  
      #Only red and white ballons will appear at the beginning
    ...
    def show(self):  #Changed balloon strings to white
        pygame.draw.line(display, white, (self.x + self.a/2, self.y + self.b), (self.x + self.a/2, self.y + self.b + self.length))
...
def pointer():
    ...
    r = 25
    l = 20
    color = yellow  #Made pointer yellow instead of green
    for i in range(noBalloon):
...
def game():
    ...
    while loop:
        ...
        display.fill(black)  #Made display black
